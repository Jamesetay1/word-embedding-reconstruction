...
test_corpus = Corpus()
test_ids = test_corpus.get_data('data/ptb.valid.txt', batch_size)
...
def main(args):
        ...
        for i in range(0, ids.size(1) - seq_length, seq_length):
            ...
            if step % 500 == 0:
                print('Epoch [{}/{}], Step[{}/{}], Loss: {:.4f}, Perplexity: {:5.2f}'
                      .format(epoch + 1, num_epochs, step, num_batches, loss.item(), np.exp(loss.item())), flush=True)
    ...
    #
    #             if (i + 1) % 100 == 0:
    #                 print('Sampled [{}/{}] words and save to {}'.format(i + 1, num_samples, 'sample.txt'), flush=True)
